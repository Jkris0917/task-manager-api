...
urlpatterns = [
    ...
    path('projects/<int:project_pk>/members/', views.add_project_member, name='add_member'),
    path('projects/<int:project_pk>/members/<int:user_pk>/', views.delete_project_member, name='delete_member')
]
